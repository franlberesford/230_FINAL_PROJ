...
xycoords <- seq(from=0,to=1,length=2)
...
mcmc_alg_meth_1(num_locs=nlocs, num_its= 10, dist_mat = distmat, X=Xs, t_cov= ts, abc_delta = .1 ,beta_prop_sigma = 0.5, theta_prop_sigma = c(0.5, 0.5))
